...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=TIME1 Demo Installer\n"
      else:
        line="OutputBaseFilename=TIME1 Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the TIME1 Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the TIME1 installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=TIME1 Demo installer\n"
     else:
       line="SetupWindowTitle=TIME1 installer\n"
